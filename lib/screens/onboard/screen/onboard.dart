...
import 'package:swapy/screens/onboard/view_model/onboard_viewModel.dart';
...
class Onboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<OnboardViewModel>(
        vmBuilder: OnboardViewModel(),
        builder: (BuildContext context, OnboardViewModel viewModel) => Scaffold(
              body: Column(
                ...
                children: [
                  Expanded(
                      flex: 3,
                      child: Image.asset(ImageConstants.onboardVector)),
                  Flexible(
                    child: AutoSizeText(
